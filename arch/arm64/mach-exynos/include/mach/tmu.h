...
#if defined(CONFIG_EXYNOS_THERMAL) && defined(CONFIG_SOC_EXYNOS7420)
...
#if defined(CONFIG_EXYNOS_THERMAL) && (defined(CONFIG_SOC_EXYNOS5433) || defined(CONFIG_SOC_EXYNOS7420))
